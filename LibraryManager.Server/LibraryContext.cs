...
namespace LibraryManager.Server
{
    public class LibraryContext : IdentityDbContext<User, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserRefreshToken>()
                .HasOne(urt => urt.User)
                .WithMany() // Можно указать тип навигационного свойства для User, если требуется
                .HasForeignKey(urt => urt.UserId);

            // Явное указание на ключи для сущностей Identity
